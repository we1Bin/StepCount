package com.weibin.step.service;
...
import com.weibin.activity.MainActivity;
import com.weibin.dylanstepcount.R;
import com.weibin.step.UpdateUiCallBack;
import com.weibin.step.accelerometer.StepCount;
import com.weibin.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener{
    ...
    private String getTodayDate(){
        ...
        SimpleDateFormat sgf = new SimpleDateFormat("yyyy-MM-dd");
        return sgf.format(date);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        if (stepSensorType == Sensor.TYPE_STEP_COUNTER){
            ...
            if (!hasRecord){
                ...
                //本次有效步数 = APP打开后所有的总步数 - 上一次APP打开之后所有记录的总步数
